<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="vprof.aspx.cs" Inherits="Admin_vprof" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Label ID="Label1" runat="server" Text="&nbsp;&nbsp;&nbsp;&nbsp;View Professional Details" CssClass="title1" Width="100%"></asp:Label>
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DefaultMode="ReadOnly"
        ...
        <Fields>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:Button ID="Button1" CssClass="button2" runat="server" OnClick="Button1_Click" Text="Block" />
