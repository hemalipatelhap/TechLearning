...
public partial class User_umyaccount : System.Web.UI.Page
{
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("select * from tblstudent where username='" + un + "'", con);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (f.HasFile)
        {
            ...
            SqlCommand cmd = new SqlCommand("update tblstudent set name=@na,education=@ed,emailid=@em,contactno=@cn,photo=@ph where username=@un", con);
        ...
        {
            SqlCommand cmd2 = new SqlCommand("update tblstudent set name=@na,education=@ed,emailid=@em,contactno=@cn where username=@un", con);
            ...
            cmd2.Parameters.AddWithValue("@un", Session["user"].ToString());
            con.Open();
